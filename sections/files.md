...
This endpoint has been deprecated. Use the "Chunked Update Version" instead. 
...
### Using the API to get a v4 UUID
...
* `POST /api/v2/files/[asset id]/[v4 uuid]/complete` will queue your file for processing. 
...
The `file_name` you use here will replace the name of the asset. Also make sure that the `file_name` has an extension. 
...
Step 2: Start uploading chunks. Notice the chunk number at the end of the path corresponds to the chunk being uploaded. 
